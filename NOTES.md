...
* ⚠️ In a real app, initial (and subsequent updates) schema is not typically generated directly by JPA. Instead, use some migration tool (e.g. Flyway) to manage schema evolution.
...
* ⚠️ No Javadoc for anything. This may be a trivial app and not really needed, but in a real world app it's important
...
[^1]: ✅ means fix is already implemented, ⚠️ means not yet fixed/implemented.
